...
$$.ListQueue = {"": "Collection;_table,_head,_tail,_modificationCount",
  ...
  remove$1: function(_, object) {
    var i, t1, t2, t3, i0, element;
    for (i = this._head, t1 = this._table, t2 = t1.length, t3 = t2 - 1; i !== this._tail; i0 = (i + 1 & t3) >>> 0, i = i0) {
      if (i < 0 || i >= t2)
        throw $.ioore(i);
      element = t1[i];
      if (typeof element !== "string")
        return this.remove$1$bailout1(1, i, object, element);
      if (element === object) {
        this._remove$1(i);
        return;
      }
  ...
  remove$1$bailout1: function(state0, i, object, element) {
    switch (state0) {
      case 0:
        i = this._head;
      case 1:
...
$$.Hostnode = {"": "Object;m_ip,m_mouseover,m_closeicon",
  delete_node$1: function(e) {
    ...
    $.Primitives_printString("this is " + this.m_ip);
    $.Primitives_printString("ip=" + this.m_ip);
    t1 = "#li" + this.m_ip;
    $.remove$0$ax($.query$1$x(document, t1));
  },
  get$delete_node: function() {
    return new $.BoundClosure$1(this, "delete_node$1");
  },
  generate_nodeadd$2: function($parent, $name) {
    var lielement, t1, t2;
  ...
  get$HiddenIcon: function() {
    return new $.BoundClosure$1(this, "HiddenIcon$1");
  }
};
...
$.Hostnode_Hostnode = function(ipstr) {
  var hostnode;
  if ($.get$Hostnode__cache().containsKey$1(ipstr) === true)
    return $.$index$asx($.get$Hostnode__cache(), ipstr);
  else {
    hostnode = $.Hostnode$_internal(ipstr);
    $.$indexSet$ax($.get$Hostnode__cache(), ipstr, hostnode);
    return hostnode;
  }
};
...
$.generate_addview = function() {
  var element = $._ElementFactoryProvider_createElement_html("<li class='span3'><div class='thumbnail' id='thumbnail_view'><div class='imgclass' id='closeicon'><div class='mycircle_out_class' id='mycircle'></div></div><img data-src='holder.js/140x140' alt='100x100' src='../public/img/add.png' style='width: 180px; height: 180px'><div class='caption'>new......</div></div></li>");
  $.add$1$ax($.get$children$x($.query$1$x(document, "#mythumbnails")), element);
  $.get$onMouseDown$x($.query$1$x(document, "#thumbnail_view")).listen$1($.Addnode);
};

$.Addnode = function(e) {
  var $name = $.JSInt_methods.toString$0($.CONSTANT0.nextInt$1(4000));
  $.Primitives_printString("name=" + $name);
  $.Hostnode_Hostnode($name).generate_nodeadd$2($.query$1$x(document, "#mythumbnails"), $name);
};

$.init_autogenerated = function() {
  var __t = $.Template$($.get$body$x(document));
  __t.create$0();
  __t.insert$0(__t);
};
...
Isolate.$lazy($, "_cache", "Hostnode__cache", "get$Hostnode__cache", function() {
  ...
  insertAdjacentElement$2: function(receiver, where, element) {
    if (Object.getPrototypeOf(this).hasOwnProperty("insertAdjacentElement$2")) {
      if (!!receiver.insertAdjacentElement)
        this._insertAdjacentElement$2(receiver, where, element);
      else
